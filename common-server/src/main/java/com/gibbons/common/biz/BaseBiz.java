package com.gibbons.common.biz;

import com.gibbons.common.util.Query;
import com.gibbons.common.util.StringHelper;
...
public abstract class BaseBiz<M extends Mapper<T>, T> {
    ...
    public TableResultResponse<T> selectByQuery(Query query) {
        ...
        if (StringHelper.isNotNull(query.getSortDire())) {
            example.setOrderByClause(query.getSortDire() + " " + query.getSortDire());
        }
